...
for mc = 1:MC
    for num_ = 1:num
        ...
        NA_JE(num_) = NA_JE(num_) + Power_Allocation_JE_ZF_MRC(BLER_TH, Nd, R_JE, L, KL, tau_p, Pt, Noise_power, akl, ckl);
...
save("Data\NA_MMSE_VS_USER_ZF.mat", "NA_JE_ZF", "NA_SE_ZF", "NA_RS_ZF")
